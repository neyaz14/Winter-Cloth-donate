...
const HowToHelp = () => {
    return (
        <div>
            <div >
                <div className='my-6'>
                    <p className='text-blue-950 text-5xl font-bold text-center'>Ways You can help</p>
                </div>
                <div className='md:grid  gap-6 md:grid-cols-4  py-3'>
            ...
            <div>
                ...
                <div className='border opacity-95 p-5 '>
                    <h1 className='font-bold   text-blue-950 text-4xl'>Follow the steps</h1>
                    <p className='text-left text-2xl text-blue-900 my-8 font-medium '> <span className='text-3xl bg-blue-100 p-3 rounded-r-full text-blue-950 font-semibold pr-4'>First step    </span> Donors register and log in.</p>
                    <p className='text-left text-2xl text-blue-900 my-8 font-medium '> <span className='text-3xl bg-blue-100 p-3 rounded-r-full text-blue-950 font-semibold pr-4'>Second step   </span> Select a campaign to support.</p>
                    <p className='text-left text-2xl text-blue-900 my-8 font-medium '> <span className='text-3xl bg-blue-100 p-3 rounded-r-full text-blue-950 font-semibold pr-4'>Third step    </span> Fill out the donation form.</p>
                    <p className='text-left text-2xl text-blue-900 my-8 font-medium '> <span className='text-3xl bg-blue-100 p-3 rounded-r-full text-blue-950 font-semibold pr-4'>Fourth step   </span> Our team coordinates the collection and distribution.</p>
                    <p className='text-left text-2xl text-blue-900 my-8 font-medium '> <span className='text-3xl bg-blue-100 p-3 rounded-r-full text-blue-950 font-semibold pr-4'>Fifth step    </span> Receive updates on how your donation made an impact.</p>
