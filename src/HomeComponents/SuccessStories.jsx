...
const SuccessStories = () => {
    return (
        <div>
            <h1 className='text-blue-950 font-bold text-5xl text-center my-10'>Our Success Stories</h1>
            <div className=''>
                <div className='md:grid lg:grid-cols-3 justify-center items-stretch gap-6 card-container  py-3'>

                    <div className="card-item my-2 card bg-blue-900 text-primary-content w-96">
